...
const resourcePath = extensionRootPath + sep + 'resource';

module.exports = class TizenCertificateDistributorSelectView {
    constructor(props) {
        this.props = props;
        this.fileInputTips = '';
    ...
    render() {
        ...
        return (
            <div className='section-container' style='overflow: hidden'>
                ...
                <p>Select an existing distributor certificate.</p>
                <div className='block' style='margin-top: 50px'>
                    <label className='inline-block text-highlight' style='font-size: 15px'>Distributor certificate file location</label>
                ...
                <div className='block' style='margin-top: 20px'>
                    ...
                    <input ref='passwordInput' className='input-text native-key-bindings' type='password' placeholder='Enter password of the distributor certificate you select' on={{focus: this.focusPasswordInput}}/>
    ...
    clickBrowseBtn() {
        dialog.showOpenDialog({
            title: 'Choose distributor certificate file',
    ...
    getInfo() {
        return {
            distributorFile: this.refs.fileInput.value,
