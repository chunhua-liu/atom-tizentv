...
const resourcePath = extensionRootPath + sep + 'resource' + sep + 'Author';

module.exports = class TizenCertificateAuthorSelectView {
    constructor(props) {
        this.props = props;
        this.fileInputTips = '';
    ...
    getInfo() {
        return {
            ...
            authorPassowrd: this.refs.passwordInput.value
        }
    }
}