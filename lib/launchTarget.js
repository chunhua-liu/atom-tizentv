...
var launchTarget = (function() {
    ...
    var EXTENSION_PATH = __dirname + path.sep + '..';
    ...
    var prepareInstall = function(dirpath, targetAddress) {
        ...
        if (targetAddressStart == 0) {
            var targetNotConfig = 'The target device address is not configured, please refer Package Settings';
                    ...
                    if (res.statusCode !=200) {  
                        ...
                        if( webInspectorValue && (webInspectorValue !='')){
                            ...
                            if ((common.getFuncMode() == common.ENUM_COMMAND_MODE.WEB_INSPECTOR_ON_TV) || (common.getFuncMode() == common.ENUM_COMMAND_MODE.WEB_INSPECTOR_ON_EMULATOR)){          				
                                var chromeExceutePath = atom.config.get('atom-extension-tizensdk.tizentv.chromeExecutable');
                                ...
                                /*function escapeRegExp(string){
                                    ...
                                    return string.replace(/([()])/g, "\\$&");
                                    //$&表示整个被匹配的字符串
                                    var NewWebInspectorValue = escapeRegExp(webInspectorValue);
                                }*/
                                ...
                                {
                                    var WebInspectorUrl = 'http://'+debugIp+webInspectorValue.replace(/([()])/g, "\\$&");;
                                }
            
                                //var WebInspectorUrl = 'http://'+debugIp+NewWebInspectorValue;
                                //var WebInspectorUrl = 'http://127.0.0.1:7011/devtools/inspector.html?ws=127.0.0.1:7011/devtools/page/5BFE5CF886B4836E5E8DEDD48ED176C8';
