...
var launchSimulator = (function() {
    ...
    var prefix = 'file:///';
    var extenstionPath = __dirname + path.sep + '..';
    ...
    var launchSimulatorApp = function (fileUrl) {
        ...
        var simulatorSettingPath = atom.config.get('atom-extension-tizensdk.tizentv.simulatorLocation');
        logger.info('simulator path is ' + simulatorSettingPath);

		var sdkInstallPath = atom.config.get('atom-extension-tizensdk.tizentv.tizenStudioLocation');
        ...
        if (simulatorSettingPath) {
            ...
            var locationNotDefine = 'The simulator location is not configured, please refer Package Settings';
