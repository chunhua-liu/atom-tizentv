...
var launchSimulator = (function() {
    ...
    var launchSimulatorApp = function (fileUrl) {
        ...
        var simulatorSettingPath = atom.config.get('atom-tizentv.tizentv.simulatorLocation');
        logger.info('simulator path is ' + simulatorSettingPath);

		var sdkInstallPath = atom.config.get('atom-tizentv.tizentv.tizenStudioLocation');
