var createProjectViewControl = (function() {
    ...
    var settingProjectProperties = function(templateType) {
        ...
        workspacePath = atom.config.get('atom-tizentv.tizentv.workspaceSetting.directory');
        workspaceDefault = atom.config.get('atom-tizentv.tizentv.workspaceSetting.setAsDefault');
    ...
    var switchPageNext = function() {
        ...
        if (pathCheck != 'success') {
            ...
            atom.config.set('atom-tizentv.tizentv.workspaceSetting.directory', workspacePath);
            atom.config.set('atom-tizentv.tizentv.workspaceSetting.setAsDefault', workspaceDefault);
            if (projectSettingPanel == null) {
                createProjectSettingPanel();
            }
            else {
