var tizenCertificate = (function(){
	...
	var developerCA = extensionPath + '/resource/certificate-generator/certificates/developer/tizen-developer-ca.cer'.split('/').join(path.sep);
	var distributorPublicCA = extensionPath + '/resource/certificate-generator/certificates/distributor/tizen-distributor-ca.cer'.split('/').join(path.sep);
	var distributorPublicSigner = extensionPath + '/resource/certificate-generator/certificates/distributor/tizen-distributor-signer.p12'.split('/').join(path.sep);
	var distributorPartnerCA = extensionPath + '/resource/certificate-generator/certificates/distributor/sdk-partner/tizen-distributor-ca.cer'.split('/').join(path.sep);
	var distributorPartnerSigner = extensionPath + '/resource/certificate-generator/certificates/distributor/sdk-partner/tizen-distributor-signer.p12'.split('/').join(path.sep);
